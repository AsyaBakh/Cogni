# Generated by Django 5.1.2 on 2024-10-11 21:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type_mbti', models.CharField(blank=True, max_length=4)),
                ...
                ('id_MBTI_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='users.mbti_type')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='users.customuser')),
            ],
        ),
        migrations.CreateModel(
            name='UserTags',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('id_tag', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='users.tag')),
                ('id_user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='users.customuser')),
            ],
            options={
